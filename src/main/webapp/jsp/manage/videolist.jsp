...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item">
                    <a href="jsp/manage/index.jsp">首页</a>
                </li>
                <li class="layui-nav-item">
                    <a class="" href="javascript:;">用户管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="manage/user/list">用户列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;">视频管理</a>
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="manage/video/list">视频列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">视频分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="manage/category/list">视频分类列表</a></dd>
                        <dd><a href="manage/category/add">添加分类</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <div class="searchDiv">
                <form class="layui-form" action="manage/video/search" method="post">
                    <span style="">搜索栏</span>
                        ...
                        <tbody>
                            <c:forEach items="${videos}" var="obj">
                                <tr>
                                    ...
                                    <td>
                                        <a href="manage/video/detail/${obj.id}" class="operateBtn">查看</a>
...
<div style="display: none" id="addForm" >
    <form class="layui-form videoAddForm" style="width: 500px;" method="get" action="manage/video/add">
...
<div style="display: none" id="updateForm" >
    <form class="layui-form videoUpdateForm" style="width: 500px;" method="post" action="manage/video/updateForForm">
...
layui.use(['element','table','layer','jquery','form','laydate','upload'], function() {
    ...
    if (video != null || video != ' ') {
        ...
        if (${video.type != null}){
            ...
            var selected = '';
            $.ajax({
                url:'manage/video/getCategoryByPid/'+type
    ...
    table.on('tool(demo)', function(obj) {
        ...
        if (layEvent == 'delete'){
            ...
            layer.confirm('确认删除视频 \"'+ data.name + '\" ?', {title:'提示'}, function(index){
                $.get('manage/video/del?id='+id1,function (data) {
                    if (data >= 1){
                        layer.msg("删除成功");
                        obj.del();
                    }else{
