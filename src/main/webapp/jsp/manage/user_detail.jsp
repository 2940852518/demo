        ...
        <div class="detail-div">
            ...
            <div class="info-div">
                ...
                <div style="width: 100%;text-align: center;margin-top: 10px;">
                    <a style="margin: 0 auto;display: inline-block; height: 30px;line-height: 30px; color: #fff; text-align: center; width: 50px;background: #4EBBF9;" href="jsp/manage/userlist.jsp">返回</a>
                </div>
            </div>
        </div>
    </div>
