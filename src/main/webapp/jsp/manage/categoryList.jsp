        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="manage/video/list">视频列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;">视频分类管理</a>
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="manage/category/list">视频分类列表</a></dd>
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'operate',title:'操作'
                    ,templet:function (d) {
                        return '<div><a href="manage/user/detail/'+ d.id +'" class="operateBtn">查看</a><a class="operateBtn" lay-event="delete">删除</a></div>';
                    }
                }
            ]]
            ,page: {
        ...
        table.on('tool(test)', function(obj) {
            ...
            if (layEvent == 'delete'){
                layer.confirm('确认删除分类 \"'+ data.categoryName + '\" ?', {title:'提示'}, function(index){
                    $.get('manage/category/delCategory?id='+data.id,function (data) {
                        if (data.result >= 1){
                            layer.msg("删除成功");
                            obj.del();
                        }else{
