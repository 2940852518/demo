        ...
        <div class="detail-div">
            ...
            <div class="info-div">
                ...
                <div style="width: 100%;text-align: center;margin-top: 10px;">
                    <a class="btn" style="" href="manage/video/list">返回</a>
                </div>
            </div>
        </div>
    </div>
...
layui.use(['element','table','layer','jquery','form','laydate','upload'], function() {
    ...
    WebUploader.Uploader.register({
        ...
        ,beforeSend:function (block) {
            ...
            $.ajax({
                type:"post"
                ,url:'manage/video/detail/checkChunk'
                ,data:{
                    fileMd5:fileMd5
                    ,chunk:block.chunk
        ...
        ,afterSendFile:function (file) {
            ...
            $.ajax({
                url:"manage/video/detail/mergeChunks"
                ,type:"post"
                ,data:{
                    fileMd5:fileMd5
                ...
                ,success:function (result) {
                    ...
                    $.ajax({
                        url:'manage/video/detail/updDetailAndDate'
                        ,type:'post'
                        ,data:{
                            id:objId,
                            fileName:result
    ...
    var uploader = WebUploader.create({
        ...
        //设置提交的服务器地址
        ,server:"manage/video/detail/upload"
        //渲染上传文件元素
        ,pick:$(".uploadBtn")
        //自动上传
        ,auto:true
                ...
                layer.open({
                    ...
                    ,success:function () {
                        $("#submit").on('click',function () {
                            $.ajax({
                                url:"manage/video/detail/addVideoDetail/"+${video.id}
                                ,type:"post"
                                ,data:{
                                    episode:$("#episode").val()
                                    ,title:$("#title").val()
        ...
        switch(obj.event){
                ...
                layer.open({
                    ...
                    ,success:function () {
                        $("#submit2").on('click',function () {
                            $.ajax({
                                url:"manage/video/detail/updDetail"
                                ,type:"post"
                                ,data:{
                                    id:id
            ...
            case 'delete':
                ...
                layer.confirm('确认删除视频 \"'+ data.title + '\" ?', {title:'提示'}, function(index){
                    $.get('manage/video/detail/del?id='+id1,function (data) {
                        if (data >= 1){
                            layer.msg("删除成功");
                            obj.del();
                        }else{
